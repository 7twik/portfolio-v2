...
const projects = [
  {
    ...
    image: trackersy,
    source_code_link: "https://github.com/7twik/dep-trackersy-frontend",
  },
  {
    name: "47Bita Pods",
    description:
  ...
  },
  {
    name: "Hawker's Hut",
    description:
      "An e-commerce website for thela-carts where thelawalas can start their buisness with real time location tech.",
    tags: [
      {
        name: "reactjs",
        color: "blue-text-gradient",
    ...
    image: hawkershut,
    source_code_link: "https://github.com/7twik/hawkershut-frontendv1",
  },
];
